...
# replace `Inception V3` with DINO v2
...
from transformers import Dinov2Model, Dinov2ForImageClassification, AutoImageProcessor
...
class DINOScore(Metric):
    r"""Calculate the DINO Score (IS) which is used to access how realistic generated images are.
    replace `Inception V3` with DINO v2
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if isinstance(feature, (str, int)):
            ...
            self.inception = Dinov2ForImageClassification.from_pretrained('facebook/dinov2-large-imagenet1k-1-layer')
            self.image_processor = AutoImageProcessor.from_pretrained("facebook/dinov2-large-imagenet1k-1-layer")
